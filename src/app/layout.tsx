...
const TITLE_BASE =
  "가나공조닥트 화성본점 | 1997 자체공장 · 공조닥트·환기덕트·공장후드 시공";
const DESCRIPTION =
  "1997년 화성 팔탄 자체공장. 49년 외길 이오복 대표가 직접 설계·제작·시공합니다. 공조닥트·환기덕트·공장후드·식당후드·벤치레이타·시로코팬·그라비아 닥트 — 무료 견적 / 시공 보증 1년 / A/S 무상.";
